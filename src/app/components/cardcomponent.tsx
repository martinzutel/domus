...
const CardComponent: React.FC<CardComponentProps> = ({ title, description, imageUrl }) => {
  return (
    <div className="h-[20rem] w-[16rem] bg-black rounded-[1rem] overflow-hidden grid grid-rows-[8rem,1fr]">
      <div className="top-0 w-full bg-slate-500 relative">
        <Image src={imageUrl} layout="fill" objectFit="cover" objectPosition="center" quality={100} alt="hero" />
      </div>
